...
| OPT-P2-03 | Remembered set deduplication | P2 | Small | — | `[x]` |
...
### `[x]` OPT-P1-06: ASCII single-char ObjString cache
...
### `[x]` OPT-P1-07: ObjClosure inline upvalue array (FAM)
...
### `[x]` OPT-P2-03: Remembered set deduplication
...
### `[x]` OPT-P2-04: ObjMap open-addressing hash table
...
### `[x]` OPT-P2-05: Coroutine SavedCallFrame direct save/restore
...
### `[x]` OPT-P2-06: Peephole NOP compaction
...
### `[x]` OPT-P3-02: Quickening deopt counter
...
### `[x]` OPT-P3-03: Compiler local variable arrays dynamic
