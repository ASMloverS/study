...
In progress. Subtasks 13.1 through 13.8 are `DONE`.
...
| 13.3 | `DONE` | 13.2 | End-to-end `import a` and `import a.b as alias` |
...
| 13.8 | `DONE` | 13.5, 13.6, 13.7 | `MS5003` and `MS5004` failures plus full module regression |
